exports.redes = function(navController){
	
	
	var winRedes = Titanium.UI.createWindow({
		title:'redes',
		backgroundColor:'#fff',
	...
	// create table view data object
		...
		for (var c=0;c<tweets.length;c++){
				...
				var bgcolor = (c % 2) == 0 ? '#E0F2F7' : '#E0F2F7';
